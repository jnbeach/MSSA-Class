...
var myArray4 = myArray[4];
// CODE HERE:
console.log("Exercise 1: I catch the value: " + myArray4);
...
// CODE HERE:
console.log("Exercise 2: I catch the value: " + number16);
...
// CODE HERE:
console.log("Exercise 3: I catch the value: " + tempAge);
...
// CODE HERE:
var stringToPrint = "Exercise 4: The " + arrayOfTeams[3]["name"] + " were founded in " + arrayOfTeams[3]["Founded"] + ". This team is from " + arrayOfTeams[3]["City"] + ".";
...
var stringToPrint2 = "Exercise 5: The " + macroObject["arrayOfTeams"][1]["name"] + " were founded in " + macroObject["arrayOfTeams"][1]["Founded"] + ".";
